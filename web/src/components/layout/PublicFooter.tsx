        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-12">
          <div className="col-span-2">
            ...
            <div className="flex gap-2 mb-6">
              <a href="https://github.com/whitestormdevil-sys/CookiePass" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="p-2 rounded-lg text-gray-400 hover:text-white hover:bg-gray-800 transition-all">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/docs/api" className="text-sm text-gray-400 hover:text-white transition-colors">API Documentation</Link></li>
