        ...
        <>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700 mt-1">
                  Password reset is currently being developed. Available in the next update.
                </p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <Input id="password" type="password" value={passwords.password} onChange={handlePasswordChange('password')} placeholder="Enter new password" disabled className="bg-gray-100" />
            ...
            <div>
              ...
              <Input id="confirmPassword" type="password" value={passwords.confirmPassword} onChange={handlePasswordChange('confirmPassword')} placeholder="Confirm new password" disabled className="bg-gray-100" />
            </div>
            {error && (
            ...
            <Button type="submit" loading={isLoading} disabled={true} className="w-full opacity-50 cursor-not-allowed">Update password</Button>
          </form>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative">
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">
            Need help?{' '}
            <Link href="/contact" className="font-medium text-indigo-600 hover:text-indigo-500">Contact support</Link>
          </p>
        </div>
      </div>
    </div>
